...
<body>
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="email" class="form-control" id="inputEmail4" placeholder="Seu nome aqui">
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Categoria</label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="Qual será a categoria?">
    </div>
  </div>
